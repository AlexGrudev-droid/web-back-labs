...
CONGRATS = {
    1: "Пусть каждый день дарит радость и вдохновение!",
    2: "Сила духа ведёт к великим свершениям!",
    3: "С Новым Годом! Пусть мечты сбываются!",
    4: "Берегите тех, кто дорог сердцу!",
    5: "Волшебство уже стучится в ваши двери!",
    6: "С Новым Счастьем! Пусть оно будет бесконечным!",
    7: "Новый этап — новые возможности!",
    8: "Подари улыбку и тёплые слова близким!",
    9: "Светлых мыслей и добрых поступков!",
    10: "Вместе мы сохраним красоту нашей планеты!",
