...
users = [
    {'login': 'alex', 'password': '111', 'name': 'Алекс Гроздов'},
    {'login': 'egor', 'password': '222', 'name': 'Егор Самсонов'},
    {'login': 'sema', 'password': '333', 'name': 'Семен Прилучный'},
    {'login': 'dima', 'password': '444', 'name': 'Дима Медведев'},
]
